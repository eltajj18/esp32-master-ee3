...
void CNRFLib_Deinit(CNRFLib *lib);
 ...
 * mode - set chip to receive or mode
 *
...
void CNRFLib_SetSleepRxMode(CNRFLib* lib);

/* Flush buffers */
void CNRFLib_FlushRX(CNRFLib *lib);
void CNRFLib_FlushTX(CNRFLib *lib);

nrf_reg_status_t CNRFLib_GetStatus();
nrf_reg_fifo_status_t CNRFLib_GetFifoStatus();
